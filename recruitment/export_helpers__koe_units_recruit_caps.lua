...
function jmw_koe_caps_sfo() 
    local jmw_koe_units = {
        ...
        --Twin Tails Orb
        {"wh_jmw_emp_cav_ttorb", "emp_elite", 1},
        {"wh_jmw_emp_inf_ttorb", "emp_elite", 1},
        --Hammers of Sigmar
        {"wh_jmw_emp_cav_hammers", "emp_elite", 1},
        {"wh_jmw_emp_inf_hammers", "emp_elite", 1},
        --Frozen Throne
...
if not _G.sfo then
    local jmw_koe_units = {
        --Reiksguard
        {"wh_main_emp_cav_reiksguard_sword", "emp_special", 2},
        {"wh_main_emp_cav_reiksguard_great", "emp_special", 2},
        {"wh_main_emp_inf_reiksguard", "emp_special", 2},
        {"wh_main_emp_inf_reiksguard_great", "emp_special", 2},
        {"wh_main_emp_inf_reiksguard_halberdiers", "emp_special", 2},
        --Blazing Sun
        {"wh_jmw_emp_cav_knights_blazing_sun_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_knights_blazing_sun_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knights_blazing_sun", "emp_special", 2},
        {"wh_jmw_emp_inf_knights_blazing_sun_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knights_blazing_sun_halberdiers", "emp_special", 2},
        --Feary Heart
        {"wh_jmw_emp_cav_fheart", "emp_special", 2},
        {"wh_jmw_emp_cav_fheart_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_fheart_great", "emp_special", 2},
        {"wh_jmw_emp_inf_fheart", "emp_special", 2},
        {"wh_jmw_emp_inf_fheart_great", "emp_special", 2},
        {"wh_jmw_emp_inf_fheart_halberdiers", "emp_special", 2},
        --Morr
        {"wh_jmw_emp_cav_kmorr", "emp_special", 2},
        {"wh_jmw_emp_cav_kmorr_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_kmorr_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kmorr", "emp_special", 2},
        {"wh_jmw_emp_inf_kmorr_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kmorr_halberdiers", "emp_special", 2},
        --Raven
        {"wh_jmw_emp_cav_krav", "emp_special", 2},
        {"wh_jmw_emp_inf_krav", "emp_special", 2},
        {"wh_jmw_emp_inf_krav_cross", "emp_special", 2},
        --Griffon
        {"wh_jmw_emp_cav_kgriff", "emp_special", 2},
        {"wh_jmw_emp_cav_kgriff_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_kgriff_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kgriff", "emp_special", 2},
        {"wh_jmw_emp_inf_kgriff_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kgriff_halberdiers", "emp_special", 2},
        {"wh_jmw_emp_cav_demigryph_kgriff", "emp_elite", 2},
        {"wh_jmw_emp_cav_demigryph_kgriff_hell", "emp_elite", 2},
        --Hunters of Sigmar
        {"wh_jmw_emp_cav_hunt", "emp_special", 2},
        {"wh_jmw_emp_cav_hunt_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_hunt_great", "emp_special", 2},
        {"wh_jmw_emp_inf_hunt", "emp_special", 2},
        {"wh_jmw_emp_inf_hunt_great", "emp_special", 2},
        {"wh_jmw_emp_inf_hunt_halberdiers", "emp_special", 2},
        --Encarmine
        {"wh_jmw_emp_cav_encarmine", "emp_special", 2},
        {"wh_jmw_emp_inf_encarmine", "emp_special", 2},
        --Golden Lion
        {"wh_jmw_emp_cav_glion", "emp_special", 2},
        {"wh_jmw_emp_cav_glion_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_glion_great", "emp_special", 2},
        {"wh_jmw_emp_inf_glion", "emp_special", 2},
        {"wh_jmw_emp_inf_glion_great", "emp_special", 2},
        {"wh_jmw_emp_inf_glion_halberdiers", "emp_special", 2},
        --Longshanks
        {"wh_jmw_emp_inf_longshanks", "emp_special", 2},
        {"wh_jmw_emp_inf_longshanks_bow", "emp_special", 2},
        --Verdant Field
        {"wh_jmw_emp_cav_vfield", "emp_special", 2},
        {"wh_jmw_emp_inf_vfield", "emp_special", 2},
        --Sigmar Blood
        {"wh_jmw_emp_cav_knightsig", "emp_special", 2},
        {"wh_jmw_emp_cav_knightsig_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_knightsig_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsig", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsig_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsig_halberdiers", "emp_special", 2},
        --Panther
        {"wh_jmw_emp_cav_knightpan_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_knightpan_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightpan", "emp_special", 2},
        {"wh_jmw_emp_inf_knightpan_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightpan_halberdiers", "emp_special", 2},
        --Black Rose
        {"wh_jmw_emp_cav_brose", "emp_special", 2},
        {"wh_jmw_emp_cav_brose_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_brose_great", "emp_special", 2},
        {"wh_jmw_emp_inf_brose", "emp_special", 2},
        {"wh_jmw_emp_inf_brose_great", "emp_special", 2},
        {"wh_jmw_emp_inf_brose_halberdiers", "emp_special", 2},
        --White Wolves
        {"wh_jmw_emp_inf_baxe", "emp_elite", 2},
        --Sons of Manann
        {"wh_jmw_emp_cav_sonsm", "emp_special", 2},
        {"wh_jmw_emp_cav_sonsm_sword", "emp_special", 2},
        {"wh_jmw_emp_inf_sonsm", "emp_special", 2},
        {"wh_jmw_emp_inf_sonsm_tri", "emp_special", 2},
        --Black Bear
        {"wh_jmw_emp_cav_bbear", "emp_special", 2},
        {"wh_jmw_emp_cav_bbear_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_bbear_great", "emp_special", 2},
        {"wh_jmw_emp_inf_bbear", "emp_special", 2},
        {"wh_jmw_emp_inf_bbear_great", "emp_special", 2},
        {"wh_jmw_emp_inf_bbear_halberdiers", "emp_special", 2},
        --Everlasting Light
        {"wh_jmw_emp_cav_elight", "emp_special", 2},
        {"wh_jmw_emp_cav_elight_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_elight_great", "emp_special", 2},
        {"wh_jmw_emp_inf_elight", "emp_special", 2},
        {"wh_jmw_emp_inf_elight_great", "emp_special", 2},
        {"wh_jmw_emp_inf_elight_halberdiers", "emp_special", 2},
        --Sacred Scyte
        {"wh_jmw_emp_cav_sacreds", "emp_special", 2},
        {"wh_jmw_emp_cav_sacreds_great", "emp_special", 2},
        {"wh_jmw_emp_inf_sacreds", "emp_special", 2},
        {"wh_jmw_emp_inf_sacreds_great", "emp_special", 2},
        --Taals Fury
        {"wh_jmw_emp_cav_demigryph_taalsf", "emp_special", 2},
        {"wh_jmw_emp_cav_demigryph_taalsf_hell", "emp_special", 2},
        {"wh_jmw_emp_inf_taalsf", "emp_special", 2},
        {"wh_jmw_emp_inf_taalsf_great", "emp_special", 2},
        {"wh_jmw_emp_inf_taalsf_halberdiers", "emp_special", 2},
        --Sigmar Fists
        {"wh_jmw_emp_cav_fist", "emp_special", 2},
        {"wh_jmw_emp_inf_fist", "emp_special", 2},
        {"wh_jmw_emp_inf_fist_cross", "emp_special", 2},
        --Mariner
        {"wh_jmw_emp_cav_mariner", "emp_special", 2},
        {"wh_jmw_emp_cav_mariner_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_mariner_great", "emp_special", 2},
        {"wh_jmw_emp_inf_mariner", "emp_special", 2},
        {"wh_jmw_emp_inf_mariner_great", "emp_special", 2},
        {"wh_jmw_emp_inf_mariner_halberdiers", "emp_special", 2},
        --Bull
        {"wh_jmw_emp_cav_bull", "emp_special", 2},
        {"wh_jmw_emp_cav_bull_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_bull_great", "emp_special", 2},
        {"wh_jmw_emp_inf_bull", "emp_special", 2},
        {"wh_jmw_emp_inf_bull_great", "emp_special", 2},
        {"wh_jmw_emp_inf_bull_halberdiers", "emp_special", 2},
        --Twin Tails Orb
        {"wh_jmw_emp_cav_ttorb", "emp_special", 2},
        {"wh_jmw_emp_inf_ttorb", "emp_special", 2},
        --Hammers of Sigmar
        {"wh_jmw_emp_cav_hammers", "emp_special", 2},
        {"wh_jmw_emp_inf_hammers", "emp_special", 2},
        --Frozen Throne
        {"wh_jmw_emp_cav_frozent", "emp_special", 2},
        {"wh_jmw_emp_cav_frozent_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_frozent_great", "emp_special", 2},
        {"wh_jmw_emp_inf_frozent", "emp_special", 2},
        {"wh_jmw_emp_inf_frozent_great", "emp_special", 2},
        {"wh_jmw_emp_inf_frozent_halberdiers", "emp_special", 2},
        --Stag
        {"wh_jmw_emp_cav_kstag", "emp_special", 2},
        {"wh_jmw_emp_cav_kstag_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_kstag_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kstag", "emp_special", 2},
        {"wh_jmw_emp_inf_kstag_great", "emp_special", 2},
        {"wh_jmw_emp_inf_kstag_halberdiers", "emp_special", 2},
        --Sword and Scale
        {"wh_jmw_emp_cav_knightsas_sword_daul", "emp_special", 2},
        {"wh_jmw_emp_cav_knightsas_sword", "emp_special", 2},
        {"wh_jmw_emp_cav_knightsas_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsas", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsas_great", "emp_special", 2},
        {"wh_jmw_emp_inf_knightsas_sword_daul", "emp_special", 2},
        --Winged Lancers
        {"wh_jmw_klv_cav_winged_lancers", "emp_rare", 2}
    }--:vector<{string, string, number?}>
    if not not rm then
        local units = jmw_koe_units
        for i = 1, #units do
